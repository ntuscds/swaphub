  ...
  return (
    <div className="vis-section">
      ...
      <h2 className="text-2xl md:text-3xl font-black mt-3 mb-8">
        How SwapHub changes everything.
      </h2>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="glass-card rounded-2xl p-5">
          ...
          <div className="flex flex-col gap-2">
            {[
              {
                label: "1. You register once",
                content: "Have 10001 → Want 10003",
                bg: "rgba(255,255,255,0.04)",
              },
              { label: "↓", content: null, bg: "transparent" },
              {
                label: "2. Engine scans 2000+ modules",
                content: "Matching…",
                bg: "rgba(255,255,255,0.04)",
              },
              { label: "↓", content: null, bg: "transparent" },
              {
                label: "✓ Match found in 0.3s",
                content: "📱 Telegram alert sent!",
                bg: "rgba(29,158,117,0.15)",
                border: "rgba(99,210,145,0.3)",
              },
              {
                label: "3. Confirm swap on SwapHub 🎉",
                content: null,
                bg: "rgba(255,255,255,0.04)",
              },
            ].map((s, i) => (
              ...
              >
                <div
                  style={{
                    fontSize: "0.7rem",
                    color: s.label.startsWith("✓")
                      ? "#1D9E75"
                      : "rgba(255,255,255,0.8)",
                    fontWeight: s.label.startsWith("✓") ? 700 : 500,
                  }}
                >
                  {s.label}
                </div>
      ...
      <div className="glass-card rounded-2xl p-5">
        ...
        <p className="text-xs text-muted-foreground mb-4">
          No human could coordinate this — SwapHub detects it instantly
        </p>
        ...
        <div className="flex items-center justify-center gap-2 mt-3">
          {THREE_WAY_STEPS.map((_, i) => (
            <button
              key={i}
              className={`step-dot-ind ${stepIdx === i ? "active" : ""}`}
            />
          ))}
        </div>
        <p className="text-center text-xs text-muted-foreground mt-2">
          {THREE_WAY_STEPS[Math.min(stepIdx, 4)]}
        </p>
      </div>
    </div>
  );
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="glass-card rounded-2xl p-5">
          <p className="font-semibold text-sm mb-1">
            ⏱ Your time saved calculator
          </p>
          <p className="text-xs text-muted-foreground mb-4">
            How many modules do you need to swap this semester?
          </p>
          ...
          <div className="grid grid-cols-2 gap-3 mb-3">
            ...
            <div
              style={{
                ...
                border: "0.5px solid rgba(99,210,145,0.3)",
                borderRadius: 8,
                padding: "0.6rem",
                textAlign: "center",
              }}
          ...
          <div>
            ...
            >
              <div
                style={{
                  height: "100%",
                  background: "linear-gradient(90deg,#6366f1,#1D9E75)",
                  borderRadius: 20,
                  width: `${savedPct}%`,
      ...
      <ScrollArea className="min-h-screen">
        <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 py-8 md:py-12">
            ...
            <div className="page-enter flex flex-col gap-6 xl:gap-7 justify-center py-8 xl:py-16">
              ...
              <div className="space-y-5">
                ...
                <p className="text-base md:text-lg text-muted-foreground max-w-xl leading-relaxed">
                  ...
                  2000+ modules — all in seconds. Built exclusively for NTU
                  students.
                </p>
              </div>
              ...
              <div className="stats-grid grid grid-cols-3 gap-3">
                <div className="metric-card glass-card rounded-xl p-4 flex flex-col items-center">
                  ...
                  <span className="text-[10px] uppercase tracking-[0.2em] text-muted-foreground mt-2 text-center">
                    Successful Swaps
                  </span>
                </div>
                <div className="metric-card glass-card rounded-xl p-4 flex flex-col items-center">
          ...
          <div className="grid md:grid-cols-3 gap-4 pt-8 md:pt-12">
            {[
              {
                title: "Smart Index Matching",
                desc: "Automatically detects direct swaps and 3-way chain swaps so everyone gets the index they want.",
                pulse: false,
              },
              {
                title: "Instant Telegram Alerts",
                desc: "Get notified the moment a compatible swap appears — no refreshing, no missed opportunities.",
                pulse: true,
              },
              {
                title: "NTU Verified Only",
                desc: "Microsoft SSO ensures every user is a real NTU student — a trusted space with zero spam.",
                pulse: false,
              },
            ].map((f) => (
              <div
                key={f.title}
                className="feature-card glass-card rounded-xl p-4 md:p-5"
              >
                <div className="flex items-start gap-4">
                  <div className="h-10 w-10 rounded-xl bg-primary/15 flex items-center justify-center shrink-0">
                    <div
                      className={`h-2 w-2 rounded-full bg-primary${f.pulse ? " animate-pulse" : ""}`}
                    />
                  </div>
                  <div>
          ...
          <div className="about-section mt-0">
            <div className="glass-card rounded-2xl p-6 md:p-10 mb-10">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed max-w-2xl">
                <p>
                  Index swapping at NTU has always been a mess — scattered
                  Telegram messages, endless back-and-forth, and deals that fall
                  through because finding a mutual match manually is nearly
                  impossible. We lived through it ourselves and decided to fix
                  it properly.
                </p>
                <p>
                  ...
                  that no human coordination could reliably pull off. If A wants
                  B&apos;s slot, B wants C&apos;s slot, and C wants A&apos;s
                  slot, SwapHub finds that chain instantly and notifies all
                  three parties at once.
                </p>
                <p>
                  No group chats. No missed DMs. Just log in with your NTU
                  account, register what you have and what you want, and let the
                  system do the rest — across 2000+ modules.
                </p>
              </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground text-sm max-w-xl">
                A mixed team of Year 1 and Year 2 Computer Science students at
                NTU Singapore, building tools that make student life genuinely
                easier.
              </p>
            </div>
