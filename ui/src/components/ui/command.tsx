...
function CommandItemBase({
  ...
  return (
    <CommandPrimitive.Item
      data-slot="command-item"
      className={cn(
        "rounded-none bg-transparent hover:bg-primary-100 focus:bg-primary-100 dark:hover:bg-primary-950 dark:focus:bg-primary-950 relative flex cursor-default items-center gap-2 px-2 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        {
          // "bg-secondary text-secondary-foreground hover:bg-secondary/90 focus:bg-secondary/90":
          "bg-primary-300 dark:bg-primary-800 text-foreground": selected,
        },
        className
      )}
      {...props}
