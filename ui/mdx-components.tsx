...
const components: MDXComponents = {
  h1: ({ children }) => (
    <h1 className="text-3xl lg:text-4xl py-2 lg:py-4 font-bold text-primary-700 dark:text-primary-400">
      {children}
    </h1>
  ),
  h2: ({ children }) => (
    <h2 className="text-xl lg:text-2xl py-2 lg:py-4 font-bold text-primary-700 dark:text-primary-400">
      {children}
    </h2>
  ),
  h3: ({ children }) => (
    <h3 className="text-base lg:text-lg py-2 lg:py-4 font-bold text-primary-700 dark:text-primary-400">
      {children}
    </h3>
  ),
  //   h4: ({ children }) => (
